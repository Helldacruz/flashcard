...
criaCartao(
    'Química',
    'Qual a carga elétrica de cada partícula?',
    'Próton: positiva; Elétron: negativa; Nêutron: neutra. '
)
...
criaCartao(
    ...
    'Português Arcaico, Português Moderno, Português Clássico e Português Contemporâneo'
)
...
criaCartao(
    'Sociologia',
    'Quais são os 5 pilares da sociologia?',
    'Os cinco elementos centrais da sociologia podem ser definidos de diferentes formas, mas frequentemente incluem estrutura social, socialização, cultura, instituições sociais e mudança social. '
)
